...
# Valid values are '2.6.39'.
mm_KERNEL_HEADERS_VERSION ?= 2.6.39
# The version of kernel to use.
# Valid values are '2.6.39'.
mm_KERNEL_VERSION         ?= 2.6.39
...
# Valid values are '96.43.19' (legacy), '173.14.30' (legacy), '275.09.07'.
mm_NVIDIA_VERSION         ?= 275.09.07
...
# the format YYYYMMDD.
mm_MYTHTV_MASTER_VERSION  ?= master-20110617-54d1f0e-8eeb80e
