...
# Valid values are '2.6.34' and '2.6.35' (does not work).
mm_KERNEL_HEADERS_VERSION ?= 2.6.34
# The version of kernel to use.
# Valid values are '2.6.34' and '2.6.35' (does not work).
mm_KERNEL_VERSION         ?= 2.6.34
...
# Valid values are '96.43.18' (legacy), '173.14.27' (legacy), '185.18.36',
# '190.53', '195.36.31', '256.44', '256.53'.
mm_NVIDIA_VERSION         ?= 256.53
