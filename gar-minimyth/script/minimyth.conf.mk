...
mm_VERSION_MYTH           ?= $(strip \
                                ...
                                $(if $(filter 0.24  ,$(mm_MYTH_VERSION)),0.24.1) \
                                $(if $(filter master,$(mm_MYTH_VERSION)),master) \
                              )
mm_VERSION_MINIMYTH       ?= 76
...
# Valid values are '2.6.38'.
mm_KERNEL_HEADERS_VERSION ?= 2.6.38
# The version of kernel to use.
# Valid values are '2.6.38'.
mm_KERNEL_VERSION         ?= 2.6.38
...
# Valid values are '96.43.19' (legacy), '173.14.30' (legacy), '270.41.06'.
mm_NVIDIA_VERSION         ?= 270.41.06
...
# the format YYYYMMDD.
mm_MYTHTV_MASTER_VERSION  ?= master-20110511-30bdb49-8eeb80e
