...
mm_GRAPHICS               ?= intel nv nvidia openchrome radeon radeonhd sis vmware
...
# Valid values are '96.43.13' (legacy), '173.14.20' (legacy), 185.18.31,
# 190.18 (beta).
mm_NVIDIA_VERSION         ?= 185.18.31
