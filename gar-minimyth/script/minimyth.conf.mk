...
# Valid values are '3.0' and '3.1'.
mm_KERNEL_HEADERS_VERSION ?= 3.1
# The version of kernel to use.
# Valid values are '3.0' and '3.1'.
mm_KERNEL_VERSION         ?= 3.1
...
# '275.36', '280.13', '285.05.09'.
mm_NVIDIA_VERSION         ?= 285.05.09
...
# the format YYYYMMDD.
mm_MYTHTV_MASTER_VERSION  ?= master-20111119-2271553-f037f74
