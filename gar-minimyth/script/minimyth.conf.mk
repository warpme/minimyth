...
# warning), 'xine', 'perl', 'transcode', 'mame', 'ps3bdremote', 'wiimote',
# 'backend', 'debug'.
...
# Valid values are '96.43.14' (legacy), '173.14.22' (legacy), '185.18.36',
# '190.42'
mm_NVIDIA_VERSION         ?= 190.42
